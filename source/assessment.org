...
* PyGame - End of Unit Self Evaluation
:PROPERTIES:
:HTML_CONTAINER_CLASS: activity
:END:
...
:HTML_CONTAINER_CLASS: try
:END:
- Right click [[./doc/PyGame – End of unit Evaluation.docx][this link]] then *Save Link As* to save this evaluation template into your homedrive.
...
:HTML_CONTAINER_CLASS: badge
:END:
- *Bronze*: Briefly evaluated all learning strands of this unit.
